...
<html>
<head>
<title>Assign Teachers for Subjects</title>
</head>
<body>
<h2>Assign Teachers for Subjects</h2>
<%
try {
...
String QueryString = "SELECT Teachers1.Subject, Classes.Subject, Teachers1.Name, Classes.class FROM Teachers1 JOIN Classes ON Teachers1.Subject = Classes.Subject  ";
