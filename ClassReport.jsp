...
String QueryString = "SELECT Students.StudentName, Students.SubjectChoice, Classes.Class, Classes.Subject, Teachers1.SUBJECT, Teachers1.NAME FROM Students INNER JOIN Classes on Classes.Subject = Students.SubjectChoice INNER JOIN TEACHERS1 ON Classes.Subject = Teachers1.SUBJECT ";
